  ...
  const detailedContent = <div className="space-y-6">
      <div className="my-0 py-0">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          <Button size="sm" variant={timeRange === "7d" ? "default" : "outline"} onClick={() => setTimeRange("7d")}>
            7 dias
          </Button>
          <Button size="sm" variant={timeRange === "30d" ? "default" : "outline"} onClick={() => setTimeRange("30d")}>
            30 dias
          </Button>
          <Button size="sm" variant={timeRange === "6m" ? "default" : "outline"} onClick={() => setTimeRange("6m")}>
            6 meses
          </Button>
          <Button size="sm" variant={timeRange === "1y" ? "default" : "outline"} onClick={() => setTimeRange("1y")}>
            1 ano
          </Button>
        </div>
