...
const ExpandableCard = ({
  ...
  return <>
      ...
      {isExpanded && <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 animate-fade-in" onClick={() => handleToggle()}>
          <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto animate-scale-in" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 my-0 py-0">
                {details}
              </div>
            </div>
          </div>
